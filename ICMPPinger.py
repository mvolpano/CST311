...
def sendOnePing(mySocket, destAddr, ID):
    ...
    print "ICMP request header:", ICMP_ECHO_REQUEST, 0, myChecksum, ID, 1
    header = struct.pack("bbHHh", ICMP_ECHO_REQUEST, 0, myChecksum, ID, 1)
...
def receiveOnePing(mySocket, ID, timeout, destAddr):
    ...
    while 1:
        ...
        print "ICMP reply header:  ", type, "  " + code, checksum, packetID, sequence_num
        if packetID == ID:
...
print
print "www.google.co.za in Africa" 
ping("www.google.co.za")
print "www.asiahotel.co.th in Asia"
ping("www.asiahotel.co.th")
print "www.australia.gov.au in Australia"
ping("www.australia.gov.au")
print "www.google.co.uk in Europe" 
ping("www.google.co.uk")
print "www.bu.edu in North America"
ping("www.bu.edu")
print "www.google.com.br in South America"
